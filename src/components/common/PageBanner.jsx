...
export default function PageBanner({ title, currentPage }) {
	return (
		<div className="container lg:px-0 px-5">
			<div className="bg-main my-4 lg:my-[60px] py-10 px-9 relative text-background text-center rounded-4xl">
				...
				<Image
					className="absolute w-28 lg:w-64 top-0 left-8 lg:left-16"
					src={LeftSVG}
					alt="Banner left svg"
				/>
				<Image
					className="absolute w-28 lg:w-64 bottom-0 right-8 lg:right-16"
					src={RightSVG}
